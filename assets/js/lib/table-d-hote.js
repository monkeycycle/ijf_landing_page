...
$(document).ready(function() {
    ...
    function exportTableToCSV($table, filename) {
        ...
        var $headers = $table.find('thead tr:has(th)'),
    ...
    function csvDownload(dataEl, filename){

      var csvDataWrapper  = document.getElementById(dataEl),
          csvData         = csvDataWrapper.innerHTML,
          csvDataEncoded  = encodeURI('data:application/csv;charset=utf-8,' + csvData);

      dlLink = document.createElement('a');
      dlLink.setAttribute('href', csvDataEncoded);
    ...
    // Event listeners
    $(".csvExportLink").click(function(e) {

        var dataEL      = e.currentTarget.dataset.csvid,
            outputFile  = 'datatable-export.csv';

        csvDownload(dataEL, outputFile);
    ...
    $(".exportLink").click(function(event) {
        ...
        exportTableToCSV.apply(this, [$('.gi-module>table'), outputFile]);
    });
